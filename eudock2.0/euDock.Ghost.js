 ...
 */
		function euGhost(id,args,container,onLoadFunc){
			...
			this.container.innerHTML   +="<div id='"+this.id+"' style='visibility:hidden;position:absolute;'></div>";
			...
			this.container.innerHTML+="<div id='"+this.id+"_OVERDIV' style='position:absolute;'></div>";
			...
			this.destroy = function(){
				...
				this.container.removeChild(document.getElementById(this.id+"_OVERDIV"));				
			};			
		};
/* 
 ****************************************
